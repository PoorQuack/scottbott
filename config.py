...
NIM_MODEL = os.getenv("NIM_MODEL", "qwen/qwen3.5-397b-a17b")
...
try:
    ...
    NIM_TIMEOUT_SIMPLE = 30.0
try:
    NIM_TIMEOUT_COMPLEX = float(os.getenv("NIM_TIMEOUT_COMPLEX", "90"))
except ValueError:
    NIM_TIMEOUT_COMPLEX = 90.0
try:
